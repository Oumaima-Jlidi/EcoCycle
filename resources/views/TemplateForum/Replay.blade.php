...
<div class="post-box d-flex mb-5 mx-0" data-aos="fade-up" data-aos-easing="linear" style="
    padding-bottom: 34px;">
    <div >
        <div class="card-header card-header-action py-3">
            <div class="media align-items-center">
                ...
                <div class="media-body">
                    <div><a href="#" style="color: #08beab;">What is your favorite AI project you found recently?</a></div>
                    <div class="fs-7"><a href="#" style="color: #08beab;">Adaline Riley</a><span class="ms-3" > 03 hrs ago in </span> <a href="#" class="cat" style="color: #08beab;">AI</a></div>
                </div>
            </div>
        </div>
