            ...
            <div class="container" style="padding-top: 64px;">
                <div class="row">
                    ...
                    <h4 class="mb-0" data-aos="fade-down" data-aos-easing="linear" style="margin-left: 45px;">
                        <i class="bi bi-plus-circle-dotted me-2"></i> Edit  Comment
                    </h4>
                        ...
                        <div class="col-11" style="margin-left: 45px;">
                            <div class="dashboard-card">
                                <div class="dashboard-body">
                                    ...
                                    <form action="{{ route('replays.update', $replay->id) }}" method="POST" >
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="content" class="form-control" rows="5" required id="editor">{{ $replay->content }}</textarea>
                                        </div>
